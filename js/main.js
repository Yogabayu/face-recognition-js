...
video.addEventListener("playing", () => {
  ...
  setInterval(async () => {
    ...
    if (resizedDetections && Object.keys(resizedDetections).length > 0) {
      ...
      document.getElementById("age").innerText = `Umur :  ${interpolatedAge}`;
      document.getElementById("gender").innerText = `Jenis Kelamin : ${gender}`;
      document.getElementById("emotion").innerText = `Emosi : ${emotion[0]}`;
    }
  }, 10);
});
